...
namespace nsMMOEngine
{
    ...
    protected:
        enum
        {
            //eTimeWaitSS_ms     = 200000,
            //eTimeWaitSlave_ms  = 200000,
            //eTimeWaitClient_ms = 200000,//### 5000,
    ...
    private:
        void SendResultAccept2ClientAndSlave(unsigned int key, void* resForClient, int sizeResClient);
