...
{
    struct DllExport TComponentTypeInformationImpl : public nsTornadoEngine::ITypeInformation
    {
        TComponentTypeInformationImpl();
        virtual ~TComponentTypeInformationImpl();
