...
namespace nsContainerCodeGenerator::nsAggregator::nsImGuiWidgets
{
    void TGenerateAggregatorHeaderSystem::Execute()
    {
        ...
        data["PARENT_FILE_NAME"] = configComponent->value.aggregator.imGuiWidgetsImpl.parent.fileName;
        ...
        data["PARENT_TYPE_NAME"] = configComponent->value.aggregator.imGuiWidgetsImpl.parent.typeName;
