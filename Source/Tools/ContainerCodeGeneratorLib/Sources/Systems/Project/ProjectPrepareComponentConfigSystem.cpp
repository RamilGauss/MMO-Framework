...
#include "ProjectPrepareComponentConfigSystem.h"
...
{
    void TProjectPrepareComponentConfigSystem::Execute()
    {
        ...
        json.externalSources->outFile = TConstants::PROJECT_COMPONENT_JSON_OUT;
        ...
        typeInfo.externalSources->outFile = TConstants::PROJECT_COMPONENT_TYPE_INFO_OUT;
        ...
        entMng.externalSources->outFile = TConstants::PROJECT_COMPONENT_ECS_OUT;
