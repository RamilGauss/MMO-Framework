...
fmt::format("        std::function<void({}::{}* {}, {}::{} {})> {};",
                s_nsECSFramework, s_TEntityManager, s_pEntMng, s_nsECSFramework, s_TEntityID, s_eid, s_addFunc),
...
fmt::format("    static void {}({}::{}* {},", s_AddComponent, s_nsECSFramework, s_TEntityManager, s_pEntMng),
