...
const std::list<std::string> TJsonSerializerHeaderFileGenerator::GetJsonImpl()
{
    return
    {
            "//------------------------------------------------------------------------------------------------------------",
            "template <typename Type>",
fmt::format("void {}::Serialize(Type* p, std::string& str)", mSerializer->className),
            "{",
            "#undef GetObject",
...
fmt::format("    {}(p, obj);", sSerializeMethod),
            ...
            "//------------------------------------------------------------------------------------------------------------",
            "template <typename Type>",
fmt::format("bool {}::Deserialize(Type* p, const std::string& str, std::string& err)", mSerializer->className),
            "{",
            "    rapidjson::Document doc(rapidjson::Type::kObjectType);",
