...
void TComponentEntityManagerExtension::Init()
{
    ...
    nsCommonWrapper_TGuidComponent_Data.addFunc = [](TEntityManager* pEntMng, TEntityID eid){ pEntMng->AddComponent<nsCommonWrapper::TGuidComponent>(eid); };
    ...
    nsCommonWrapper_TNameComponent_Data.addFunc = [](TEntityManager* pEntMng, TEntityID eid){ pEntMng->AddComponent<nsCommonWrapper::TNameComponent>(eid); };
    ...
    nsCommonWrapper_TParentGuidComponent_Data.addFunc = [](TEntityManager* pEntMng, TEntityID eid){ pEntMng->AddComponent<nsCommonWrapper::TParentGuidComponent>(eid); };
    ...
    nsCommonWrapper_TSceneEditingComponent_Data.addFunc = [](TEntityManager* pEntMng, TEntityID eid){ pEntMng->AddComponent<nsCommonWrapper::TSceneEditingComponent>(eid); };
    ...
    nsCommonWrapper_TSceneGuidComponent_Data.addFunc = [](TEntityManager* pEntMng, TEntityID eid){ pEntMng->AddComponent<nsCommonWrapper::TSceneGuidComponent>(eid); };
    ...
    nsCommonWrapper_TSceneRootComponent_Data.addFunc = [](TEntityManager* pEntMng, TEntityID eid){ pEntMng->AddComponent<nsCommonWrapper::TSceneRootComponent>(eid); };
    ...
    nsCommonWrapper_TTransformComponent_Data.addFunc = [](TEntityManager* pEntMng, TEntityID eid){ pEntMng->AddComponent<nsCommonWrapper::TTransformComponent>(eid); };
    ...
    nsGraphicWrapper_TCameraComponent_Data.addFunc = [](TEntityManager* pEntMng, TEntityID eid){ pEntMng->AddComponent<nsGraphicWrapper::TCameraComponent>(eid); };
    ...
    nsGraphicWrapper_TLightComponent_Data.addFunc = [](TEntityManager* pEntMng, TEntityID eid){ pEntMng->AddComponent<nsGraphicWrapper::TLightComponent>(eid); };
    ...
    nsGuiWrapper_TButtonClickHandlerComponent_Data.addFunc = [](TEntityManager* pEntMng, TEntityID eid){ pEntMng->AddComponent<nsGuiWrapper::TButtonClickHandlerComponent>(eid); };
    ...
    nsGuiWrapper_TButtonComponent_Data.addFunc = [](TEntityManager* pEntMng, TEntityID eid){ pEntMng->AddComponent<nsGuiWrapper::TButtonComponent>(eid); };
    ...
    nsGuiWrapper_TFocusComponent_Data.addFunc = [](TEntityManager* pEntMng, TEntityID eid){ pEntMng->AddComponent<nsGuiWrapper::TFocusComponent>(eid); };
    ...
    nsGuiWrapper_TPositionComponent_Data.addFunc = [](TEntityManager* pEntMng, TEntityID eid){ pEntMng->AddComponent<nsGuiWrapper::TPositionComponent>(eid); };
    ...
    nsGuiWrapper_TSizeComponent_Data.addFunc = [](TEntityManager* pEntMng, TEntityID eid){ pEntMng->AddComponent<nsGuiWrapper::TSizeComponent>(eid); };
    ...
    nsGuiWrapper_TTitleComponent_Data.addFunc = [](TEntityManager* pEntMng, TEntityID eid){ pEntMng->AddComponent<nsGuiWrapper::TTitleComponent>(eid); };
    ...
    nsGuiWrapper_TVisibilityComponent_Data.addFunc = [](TEntityManager* pEntMng, TEntityID eid){ pEntMng->AddComponent<nsGuiWrapper::TVisibilityComponent>(eid); };
    ...
    nsGuiWrapper_TWindowComponent_Data.addFunc = [](TEntityManager* pEntMng, TEntityID eid){ pEntMng->AddComponent<nsGuiWrapper::TWindowComponent>(eid); };
