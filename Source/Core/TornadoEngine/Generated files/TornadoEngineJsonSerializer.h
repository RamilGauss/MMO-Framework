...
// File has been generated at 2025_01_10 17:01:10.601
#pragma once
...
namespace nsTornadoEngine
{
    ...
    public:
        ...
        static void _Serialize(nsTornadoEngine::TLoggerConfig* p, Jobj& obj);
        static void _Deserialize(nsTornadoEngine::TLoggerConfig* p, const Jobj& obj);
    ...
    //------------------------------------------------------------------------------------------------------------
    template <typename Type>
    void TTornadoEngineJsonSerializer::Serialize(Type* p, std::string& str)
    {
    #undef GetObject
    ...
    //------------------------------------------------------------------------------------------------------------
    template <typename Type>
    bool TTornadoEngineJsonSerializer::Deserialize(Type* p, const std::string& str, std::string& err)
    {
        rapidjson::Document doc(rapidjson::Type::kObjectType);
