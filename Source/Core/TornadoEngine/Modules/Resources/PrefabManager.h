...
namespace nsTornadoEngine
{
    ...
    public:
        ...
        nsECSFramework::TEntityID InstantiateByGuid(TInstantiatePrefabParams instantiatePrefabParams);
        nsECSFramework::TEntityID InstantiateByAbsPath(const TInstantiatePrefabParams& instantiatePrefabParams);
