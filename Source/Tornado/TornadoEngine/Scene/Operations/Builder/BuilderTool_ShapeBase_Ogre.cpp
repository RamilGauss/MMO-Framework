...
TBuilderTool_ShapeBase_Ogre::TBuilderTool_ShapeBase_Ogre()
{
  mPtrMO = nullptr;
  mPtrShape = nullptr;
  mPtrMaterial = nullptr;
  mPtrMaterialVariant = nullptr;
  mPtrSceneMng = nullptr;
  mPtrEntity = nullptr;
...
//-----------------------------------------------------------------------------
std::string TBuilderTool_ShapeBase_Ogre::GetNameType()
{
  return GetRandomString( 10 ) + "_" + typeid( *this ).name();// "_Cylinder";
}
//-------------------------------------------------------------------------
