    ...
    TFactoryBehaviourPattern* pFBP, TScene* pScene, int id_world)
{
    ...
    flgUsePhysic = bool(mSetID_Module.find(PhysicEngine) != mSetID_Module.end());
    flgUseGraphic = bool(mSetID_Module.find(GraphicEngine) != mSetID_Module.end());
    flgUseSound = bool(mSetID_Module.find(SoundEngine) != mSetID_Module.end());
}
//------------------------------------------------------------------------
