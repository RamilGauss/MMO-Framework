...
protected:
  ...
  PrototypeMakerObjectGeneral* mMakerObjectGeneral;// создает объект заданного типа поведения
...
public:
  ...
  void SetMakerObjectGeneral(PrototypeMakerObjectGeneral* pMakerObjectGeneral);
