...
class DllExport TObjectGE : public TBaseObjectGE
{
protected:
...
public:
  TObjectGE(int typeDX = eDirtyAnimate);
  virtual ~TObjectGE();
  ...
  // должно быть задано время начало жизни, см. TBaseObjectGE::mTimeCreation - хрень хрень
  ...
  virtual bool Animate(unsigned int time_ms/*dirty animate ignore this parameter*/){return true;}
