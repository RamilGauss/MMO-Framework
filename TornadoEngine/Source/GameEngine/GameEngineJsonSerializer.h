...
*/
// File has been generated by ReflectionCodeGenerator version 1.13 build 41, at 2020_09_03 08:33:24.454
...
//------------------------------------------------------------------------------------------------------------
template <typename Type>
static void TGameEngineJsonSerializer::Deserialize( Type*& p, std::string& str )
{
    _Deserialize( p, str, true );
}
//------------------------------------------------------------------------------------------------------------
template <typename Type>
static void TGameEngineJsonSerializer::Fill( Type* p, std::string& str )
{
    _Deserialize( p, str, false );
}
//------------------------------------------------------------------------------------------------------------
template <typename Type>
static void TGameEngineJsonSerializer::_Deserialize( Type*& p, std::string& str, bool checkPtr )
{
    std::string err;
