...
22.08.2014:
  ...
  я смогу сделать встраивание и синхронизацию OGRE-Bullet. Mingun, спасибо за инвайт!
  
  Lair может и прав на счет надежности ММО. Но: надежность здесь нужна лишь для проведения
  игры в комнате до конца. А для этого достаточно закомментировать вызов DisconnectAllClient()
  в классе TSlave на событие разрыва связи с Мастером. То есть дать возможность провести
  игру до конца, а то что не удаться авторизоваться или создать новую группу клиентов -
  на это вообще по фигу.
...
18.09.2014:
  Melissa будет самостоятельным проектом на Github.com, но как дублирующее ответвление от Tornado.
24.09.2014:
