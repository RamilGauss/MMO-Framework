...
08.10.2014:
  ...
  не происходило выделение ппамяти.
  Задачи на октябрь: 
...
17.11.2014:
  Тестил CMarkup под Ubuntu, все работает. Видимо, глючило только под МСВС.
    ...
    So  T  Ne
     Gr   Ph
  Ни разу здесь об этом не писал. Что бы преодолеть барьер: в пятницу куплю шоколад.
  В воскресенье с утра накачу и на охоту. Все же основная проблема - отсутствие общительности.
  Может это потом разовьется? С одной стороны слова есть, надо только научиться их говорить.
//----------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------
    TODO:
