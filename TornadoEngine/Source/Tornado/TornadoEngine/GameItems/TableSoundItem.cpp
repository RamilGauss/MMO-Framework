...
{
  int iMass1 = 0;
  for( auto& vecMass1 : mVecParam.v )// velocity
  {
    int iMass0 = 0;
    for( auto& vecMass0 : vecMass1.v )// mass1
    {
      int iMaterial1 = 0;
      for( auto& vecMaterial1 : vecMass0.v )// mass0
      {
        int iMaterial0 = 0;
        for( auto& vecMaterial0 : vecMaterial1.v )// material1
        {
          int iAngle = 0;
          for( auto& vecAngle : vecMaterial0.v )// material0
          {
            int iVec = 0;
            for( auto& vecMapStrStr : vecAngle.v )// angle
            {
