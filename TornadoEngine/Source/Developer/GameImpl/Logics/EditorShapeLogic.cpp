...
TEditorShapeLogic::TEditorShapeLogic()
{
  mEditorShape = NULL;
}
//-------------------------------------------------------------------
...
void TEditorShapeLogic::InitLog()
{
  ...
  GetLogger()->Init("EditorShape");
}
//-------------------------------------------------------------------
bool TEditorShapeLogic::WorkClient()
{
  return true;
}
//-------------------------------------------------------------------
void TEditorShapeLogic::Input(int id_sender, void* p, int size)
{
  switch(id_sender)
  {
...
//-------------------------------------------------------------------
void TEditorShapeLogic::StartTimer()
{
  // вызовется из потока таймера
  unsigned int mID_Timer = mComp.pTimer->New(100);
}
//----------------------------------------------------------
void TEditorShapeLogic::InitForms()
{
  mEditorShape = new TEditorShape;
  mEditorShape->Show();
}
//----------------------------------------------------------
void TEditorShapeLogic::GraphicBeginWork()
{
  CheckMoveCamera();
}
//---------------------------------------------------------------------------------------------
void TEditorShapeLogic::FreeGraphicResource()
{
  delete mEditorShape;
}
//---------------------------------------------------------------------------------------------
void TEditorShapeLogic::HandleGraphicEngine(void* p, int size)
{
...
//---------------------------------------------------------------------------------------------
void TEditorShapeLogic::HandleMouseEvent(void* p)
{
...
//---------------------------------------------------------------------------------------------
void TEditorShapeLogic::HandleKeyEvent(void* p)
{
...
//---------------------------------------------------------------------------------------------
void TEditorShapeLogic::CheckMoveCamera()
{
  Ogre::Camera* pCamera = mComp.pGraphicEngine->GetGE()->GetCamera();
...
//---------------------------------------------------------------------------------------------
void TEditorShapeLogic::CalcMoveForAxe(TDriveCamera::TMove* pMove, float* pAxe)
{
