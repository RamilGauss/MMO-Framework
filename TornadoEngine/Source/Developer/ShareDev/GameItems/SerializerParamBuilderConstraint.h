...
class DllExport TSerializerParamBuilderConstraint
{
    ...
    TCallBackRegistrator0 mCB_Generic6DofToStruct;
    TCallBackRegistrator0 mCB_Generic6DofToStr;
    TCallBackRegistrator0 mCB_Generic6DofSpringToStruct;
    TCallBackRegistrator0 mCB_Generic6DofSpringToStr;
    TCallBackRegistrator0 mCB_FixedToStruct;
    TCallBackRegistrator0 mCB_FixedToStr;
    TCallBackRegistrator0 mCB_SliderToStruct;
    TCallBackRegistrator0 mCB_SliderToStr;
    TCallBackRegistrator0 mCB_ConeTwistToStruct; TCallBackRegistrator0  mCB_ConeTwistToStr;
    TCallBackRegistrator0 mCB_HingeToStruct; TCallBackRegistrator0  mCB_HingeToStr;
    TCallBackRegistrator0 mCB_Hinge2ToStruct; TCallBackRegistrator0  mCB_Hinge2ToStr;
    TCallBackRegistrator0 mCB_Point2PointToStruct; TCallBackRegistrator0  mCB_Point2PointToStr;
    TCallBackRegistrator0 mCB_GearToStruct; TCallBackRegistrator0  mCB_GearToStr;
