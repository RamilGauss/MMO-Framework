...
#include "SqlFileGenerator.h"
#include "fmt/core.h"

namespace nsReflectionCodeGenerator
{
    class TSqlHeaderFileGenerator : public TSqlFileGenerator
    {
        ...
        const std::list<std::string> s_JsonImpl =
        {
            "//------------------------------------------------------------------------------------------------------------",
            "template <typename Type>",
            fmt::format("static void {}::Serialize( Type* p, std::string& str )", mSqlConfig->className),
            "{",
            "  Jobj obj;",
            ...
            "//------------------------------------------------------------------------------------------------------------",
            "template <typename Type>",
            fmt::format("static void {}::Deserialize( Type*& p, std::string& str )", mSqlConfig->className),
            "{",
            "  _Deserialize( p, str, true );",
            "}",
            "//------------------------------------------------------------------------------------------------------------",
            "template <typename Type>",
            fmt::format("static void {}::Fill( Type* p, std::string& str )", mSqlConfig->className),
            "{",
            "  _Deserialize( p, str, false );",
            "}",
            "//------------------------------------------------------------------------------------------------------------",
            "template <typename Type>",
            fmt::format("static void {}::_Deserialize( Type*& p, std::string& str, bool checkPtr )", mSqlConfig->className),
            "{",
            "  std::string err;",
