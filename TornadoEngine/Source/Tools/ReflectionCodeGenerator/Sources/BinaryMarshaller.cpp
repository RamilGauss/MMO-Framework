...
*/
// File has been generated by ReflectionCodeGenerator version 1.14 build 42, at 2020_09_13 14:04:07.836
...
void TBinaryMarshaller::Unpack( char* packedData, int size )
{
    ...
    switch( type )
    {
        ...
        break;
        case e_nsMathTools_TMatrix16:
        {
            auto p = Allocate<nsMathTools::TMatrix16>();
            _Deserialize( p );
            TUnpackHandler::Handle( p );
        }
        break;
        case e_nsMathTools_TMatrix9:
        {
            auto p = Allocate<nsMathTools::TMatrix9>();
            _Deserialize( p );
            TUnpackHandler::Handle( p );
        }
        break;
        case e_nsMathTools_TOrientation:
        {
            auto p = Allocate<nsMathTools::TOrientation>();
            _Deserialize( p );
            TUnpackHandler::Handle( p );
        }
        break;
        case e_nsMathTools_TPlane:
        {
            auto p = Allocate<nsMathTools::TPlane>();
            _Deserialize( p );
            TUnpackHandler::Handle( p );
        }
        break;
        case e_nsMathTools_TPoint2:
        {
            auto p = Allocate<nsMathTools::TPoint2>();
            _Deserialize( p );
            TUnpackHandler::Handle( p );
        }
        break;
        case e_nsMathTools_TQuaternion:
        {
            auto p = Allocate<nsMathTools::TQuaternion>();
            _Deserialize( p );
            TUnpackHandler::Handle( p );
        }
        break;
        case e_nsMathTools_TVector2:
        {
            auto p = Allocate<nsMathTools::TVector2>();
            _Deserialize( p );
            TUnpackHandler::Handle( p );
        }
        break;
        case e_nsMathTools_TVector3:
        {
            auto p = Allocate<nsMathTools::TVector3>();
            _Deserialize( p );
            TUnpackHandler::Handle( p );
        }
        break;
        case e_nsMathTools_TVector4:
        {
            auto p = Allocate<nsMathTools::TVector4>();
            _Deserialize( p );
            TUnpackHandler::Handle( p );
        }
        break;
...
void TBinaryMarshaller::_Serialize( nsBS::TBaseStruct* p )
{
    ...
    TBinaryMaster::SizeType iiMap_size0 = (TBinaryMaster::SizeType)(p->iiMap.size());
    mPushMaster.PushNum( iiMap_size0 );
    for ( auto& iiMap_e0 : p->iiMap )
    {
        mPushMaster.PushNum( iiMap_e0.first );
        mPushMaster.PushNum( iiMap_e0.second );
    }
    mPushMaster.PushNum( p->a );
    mPushMaster.PushNum( p->b );
    mPushMaster.PushNum( p->c );
    mPushMaster.PushNum( p->d );
...
void TBinaryMarshaller::_Deserialize( nsBS::TBaseStruct* p )
{
    ...
    p->iiMap.clear();
    TBinaryMaster::SizeType iiMap_size0;
    mPopMaster.PopNum( iiMap_size0 );
    for ( TBinaryMaster::SizeType iiMap_i0 = 0 ; iiMap_i0 < iiMap_size0 ; iiMap_i0++ ) 
    {
        int iiMap_key0;
        mPopMaster.PopNum( iiMap_key0 );
        int iiMap_value0;
        mPopMaster.PopNum( iiMap_value0 );
        p->iiMap.insert( { iiMap_key0, iiMap_value0 } );
    }
    mPopMaster.PopNum( p->a );
    mPopMaster.PopNum( p->b );
    mPopMaster.PopNum( p->c );
    mPopMaster.PopNum( p->d );
...
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Serialize( nsMathTools::TMatrix16* p )
{
    mPushMaster.PushNum( p->_11 );
    mPushMaster.PushNum( p->_12 );
    mPushMaster.PushNum( p->_13 );
    mPushMaster.PushNum( p->_14 );
    mPushMaster.PushNum( p->_21 );
    mPushMaster.PushNum( p->_22 );
    mPushMaster.PushNum( p->_23 );
    mPushMaster.PushNum( p->_24 );
    mPushMaster.PushNum( p->_31 );
    mPushMaster.PushNum( p->_32 );
    mPushMaster.PushNum( p->_33 );
    mPushMaster.PushNum( p->_34 );
    mPushMaster.PushNum( p->_41 );
    mPushMaster.PushNum( p->_42 );
    mPushMaster.PushNum( p->_43 );
    mPushMaster.PushNum( p->_44 );
}
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Deserialize( nsMathTools::TMatrix16* p )
{
    mPopMaster.PopNum( p->_11 );
    mPopMaster.PopNum( p->_12 );
    mPopMaster.PopNum( p->_13 );
    mPopMaster.PopNum( p->_14 );
    mPopMaster.PopNum( p->_21 );
    mPopMaster.PopNum( p->_22 );
    mPopMaster.PopNum( p->_23 );
    mPopMaster.PopNum( p->_24 );
    mPopMaster.PopNum( p->_31 );
    mPopMaster.PopNum( p->_32 );
    mPopMaster.PopNum( p->_33 );
    mPopMaster.PopNum( p->_34 );
    mPopMaster.PopNum( p->_41 );
    mPopMaster.PopNum( p->_42 );
    mPopMaster.PopNum( p->_43 );
    mPopMaster.PopNum( p->_44 );
}
//---------------------------------------------------------------------------------------
TBinaryMarshaller::TypeID TBinaryMarshaller::_GetTypeID( nsMathTools::TMatrix16* p )
{
    return e_nsMathTools_TMatrix16;
}
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Deallocate( nsMathTools::TMatrix16* p )
{
}
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Serialize( nsMathTools::TMatrix9* p )
{
    mPushMaster.PushNum( p->_11 );
    mPushMaster.PushNum( p->_12 );
    mPushMaster.PushNum( p->_13 );
...
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Deserialize( nsMathTools::TMatrix9* p )
{
    mPopMaster.PopNum( p->_11 );
    mPopMaster.PopNum( p->_12 );
    mPopMaster.PopNum( p->_13 );
...
//---------------------------------------------------------------------------------------
TBinaryMarshaller::TypeID TBinaryMarshaller::_GetTypeID( nsMathTools::TMatrix9* p )
{
    return e_nsMathTools_TMatrix9;
}
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Deallocate( nsMathTools::TMatrix9* p )
{
}
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Serialize( nsMathTools::TOrientation* p )
{
    auto axis_p = &(p->axis);
    PushIsNotNullptr( axis_p );
    if ( axis_p )
        _Serialize( axis_p );
    mPushMaster.PushNum( p->angle );
}
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Deserialize( nsMathTools::TOrientation* p )
{
    if ( PopIsNotNullptr() )
    {
        _Deserialize( &(p->axis) );
    }
    mPopMaster.PopNum( p->angle );
}
//---------------------------------------------------------------------------------------
TBinaryMarshaller::TypeID TBinaryMarshaller::_GetTypeID( nsMathTools::TOrientation* p )
{
    return e_nsMathTools_TOrientation;
}
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Deallocate( nsMathTools::TOrientation* p )
{
}
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Serialize( nsMathTools::TPlane* p )
{
    mPushMaster.PushNum( p->a );
    mPushMaster.PushNum( p->b );
    mPushMaster.PushNum( p->c );
...
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Deserialize( nsMathTools::TPlane* p )
{
    mPopMaster.PopNum( p->a );
    mPopMaster.PopNum( p->b );
    mPopMaster.PopNum( p->c );
...
//---------------------------------------------------------------------------------------
TBinaryMarshaller::TypeID TBinaryMarshaller::_GetTypeID( nsMathTools::TPlane* p )
{
    return e_nsMathTools_TPlane;
}
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Deallocate( nsMathTools::TPlane* p )
{
}
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Serialize( nsMathTools::TPoint2* p )
{
    mPushMaster.PushNum( p->x );
    mPushMaster.PushNum( p->y );
}
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Deserialize( nsMathTools::TPoint2* p )
{
    mPopMaster.PopNum( p->x );
    mPopMaster.PopNum( p->y );
}
//---------------------------------------------------------------------------------------
TBinaryMarshaller::TypeID TBinaryMarshaller::_GetTypeID( nsMathTools::TPoint2* p )
{
    return e_nsMathTools_TPoint2;
}
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Deallocate( nsMathTools::TPoint2* p )
{
}
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Serialize( nsMathTools::TQuaternion* p )
{
    mPushMaster.PushNum( p->x );
    mPushMaster.PushNum( p->y );
    mPushMaster.PushNum( p->z );
...
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Deserialize( nsMathTools::TQuaternion* p )
{
    mPopMaster.PopNum( p->x );
    mPopMaster.PopNum( p->y );
    mPopMaster.PopNum( p->z );
...
//---------------------------------------------------------------------------------------
TBinaryMarshaller::TypeID TBinaryMarshaller::_GetTypeID( nsMathTools::TQuaternion* p )
{
    return e_nsMathTools_TQuaternion;
}
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Deallocate( nsMathTools::TQuaternion* p )
{
}
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Serialize( nsMathTools::TVector2* p )
{
    mPushMaster.PushNum( p->x );
    mPushMaster.PushNum( p->y );
}
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Deserialize( nsMathTools::TVector2* p )
{
    mPopMaster.PopNum( p->x );
    mPopMaster.PopNum( p->y );
}
//---------------------------------------------------------------------------------------
TBinaryMarshaller::TypeID TBinaryMarshaller::_GetTypeID( nsMathTools::TVector2* p )
{
    return e_nsMathTools_TVector2;
}
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Deallocate( nsMathTools::TVector2* p )
{
}
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Serialize( nsMathTools::TVector3* p )
{
    mPushMaster.PushNum( p->x );
    mPushMaster.PushNum( p->y );
    mPushMaster.PushNum( p->z );
...
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Deserialize( nsMathTools::TVector3* p )
{
    mPopMaster.PopNum( p->x );
    mPopMaster.PopNum( p->y );
    mPopMaster.PopNum( p->z );
...
//---------------------------------------------------------------------------------------
TBinaryMarshaller::TypeID TBinaryMarshaller::_GetTypeID( nsMathTools::TVector3* p )
{
    return e_nsMathTools_TVector3;
}
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Deallocate( nsMathTools::TVector3* p )
{
}
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Serialize( nsMathTools::TVector4* p )
{
    mPushMaster.PushNum( p->x );
    mPushMaster.PushNum( p->y );
    mPushMaster.PushNum( p->z );
...
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Deserialize( nsMathTools::TVector4* p )
{
    mPopMaster.PopNum( p->x );
    mPopMaster.PopNum( p->y );
    mPopMaster.PopNum( p->z );
...
//---------------------------------------------------------------------------------------
TBinaryMarshaller::TypeID TBinaryMarshaller::_GetTypeID( nsMathTools::TVector4* p )
{
    return e_nsMathTools_TVector4;
}
//---------------------------------------------------------------------------------------
void TBinaryMarshaller::_Deallocate( nsMathTools::TVector4* p )
{
}
//---------------------------------------------------------------------------------------
