...
void TEntityManagerSourceFileGenerator::Work()
{
    ...
    AddInclude(mEntityManagerConfig->fileName + ".h");
    AddEmptyLine();

    auto namespaceName = mEntityManagerConfig->nameSpaceName;
    ...
    auto defMap = fmt::format("std::map<std::string, {}::{}> {}::{};",
        mEntityManagerConfig->className, s_Data, mEntityManagerConfig->className, s_mTypeNameMap);
    Add(defMap);
...
void TEntityManagerSourceFileGenerator::AddInit()
{
    ...
    AddMethodImplementationBegin(s_Void, mEntityManagerConfig->className, s_Init, paramList);
    AddLeftBrace();
    IncrementTabs();
...
void TEntityManagerSourceFileGenerator::AddMethodDeinitions()
{
    ...
    AddMethodImplementationBegin(s_Void, mEntityManagerConfig->className, s_SetComponent, paramList);
    AddLeftBrace();
    IncrementTabs();
    ...
    AddMethodImplementationBegin(ret, mEntityManagerConfig->className, s_ViewComponent, paramList);
    AddLeftBrace();
    IncrementTabs();
    ...
    AddMethodImplementationBegin(s_Bool, mEntityManagerConfig->className, s_GetComponent, paramList);
    AddLeftBrace();
    IncrementTabs();
    ...
    AddMethodImplementationBegin(s_Bool, mEntityManagerConfig->className, s_HasComponent, paramList);
    AddLeftBrace();
    IncrementTabs();
    ...
    AddMethodImplementationBegin(s_Void, mEntityManagerConfig->className, s_RemoveComponent, paramList);
    AddLeftBrace();
    IncrementTabs();
