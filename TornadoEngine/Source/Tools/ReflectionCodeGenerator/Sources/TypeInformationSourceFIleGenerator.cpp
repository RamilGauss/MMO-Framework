...
void TTypeInformationSourceFileGenerator::Work()
{
    ...
    AddInclude(mTypeInformationConfig->fileName + ".h");
    AddEmptyLine();
    ...
    std::string str;
    str = fmt::format("std::list<std::string> {}::{};", mTypeInformationConfig->className, s_mTypeNameList);
    Add(str);
    str = fmt::format("std::list<int> {}::{};", mTypeInformationConfig->className, s_mTypeIdentifierList);
    Add(str);

    AddEmptyLine();

    str = fmt::format("std::map<int, std::string> {}::{};", mTypeInformationConfig->className, s_mIdentifierNameMap);
    Add(str);
    str = fmt::format("std::map<std::string, int> {}::{};", mTypeInformationConfig->className, s_mNameIdentifierMap);
    Add(str);
...
void TTypeInformationSourceFileGenerator::AddInit()
{
    ...
    AddMethodImplementationBegin(s_Void, mTypeInformationConfig->className, s_Init, paramList);
    AddLeftBrace();
    IncrementTabs();
...
void TTypeInformationSourceFileGenerator::AddMethodDeinitions()
{
    ...
    AddMethodImplementationBegin(ret, mTypeInformationConfig->className, s_GetTypeNameList, paramList);
    AddLeftBrace();
    IncrementTabs();
    ...
    AddMethodImplementationBegin(ret, mTypeInformationConfig->className, s_GetTypeIdentifierList, paramList);
    AddLeftBrace();
    IncrementTabs();
    ...
    AddMethodImplementationBegin(ret, mTypeInformationConfig->className, s_ConvertTypeToName, paramList);
    AddLeftBrace();
    IncrementTabs();
    ...
    AddMethodImplementationBegin(ret, mTypeInformationConfig->className, s_ConvertNameToType, paramList);
    AddLeftBrace();
    IncrementTabs();
