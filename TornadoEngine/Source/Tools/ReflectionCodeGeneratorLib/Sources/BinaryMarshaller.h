...
*/
// File has been generated by ReflectionCodeGenerator version 1.18 build 46, at 2020_10_18 14:39:03.284
...
namespace nsBinary
{
    ...
    public:
        ...
        {
            e_nsReflectionCodeGenerator_TBinaryMarshallerGeneratorConfig = 666,
            e_nsReflectionCodeGenerator_TClassDesc,
            e_nsReflectionCodeGenerator_TConfig,
            e_nsReflectionCodeGenerator_TEntityManagerGeneratorConfig,
            e_nsReflectionCodeGenerator_TExternalSource,
            e_nsReflectionCodeGenerator_TExternalSourceList,
            ...
            e_nsReflectionCodeGenerator_TMyGuiGeneratorConfig,
            e_nsReflectionCodeGenerator_TReflectionGeneratorConfig,
            ...
            e_nsReflectionCodeGenerator_TTypeInformationGeneratorConfig,
    ...
    private:
        ...
        //void _Serialize( nsReflectionCodeGenerator::TEntityManagerGeneratorConfig* p );
        //void _Deserialize( nsReflectionCodeGenerator::TEntityManagerGeneratorConfig* p );
        //TypeID _GetTypeID( nsReflectionCodeGenerator::TEntityManagerGeneratorConfig* p );
        //static void _Deallocate( nsReflectionCodeGenerator::TEntityManagerGeneratorConfig* p );
        ...
        //
        //void _Serialize( nsReflectionCodeGenerator::TMyGuiGeneratorConfig* p );
        //void _Deserialize( nsReflectionCodeGenerator::TMyGuiGeneratorConfig* p );
        //TypeID _GetTypeID( nsReflectionCodeGenerator::TMyGuiGeneratorConfig* p );
        //static void _Deallocate( nsReflectionCodeGenerator::TMyGuiGeneratorConfig* p );
        //
        //void _Serialize( nsReflectionCodeGenerator::TReflectionGeneratorConfig* p );
        //void _Deserialize( nsReflectionCodeGenerator::TReflectionGeneratorConfig* p );
        //TypeID _GetTypeID( nsReflectionCodeGenerator::TReflectionGeneratorConfig* p );
        //static void _Deallocate( nsReflectionCodeGenerator::TReflectionGeneratorConfig* p );
        ...
        //void _Serialize( nsReflectionCodeGenerator::TTypeInformationGeneratorConfig* p );
        //void _Deserialize( nsReflectionCodeGenerator::TTypeInformationGeneratorConfig* p );
        //TypeID _GetTypeID( nsReflectionCodeGenerator::TTypeInformationGeneratorConfig* p );
        //static void _Deallocate( nsReflectionCodeGenerator::TTypeInformationGeneratorConfig* p );
