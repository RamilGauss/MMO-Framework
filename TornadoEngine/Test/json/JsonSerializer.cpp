...
test
*/
// File has been generated by ReflectionCodeGenerator version 1.15 build 43, at 2020_09_25 20:04:35.322
...
void TJsonSerializer::Init()
{
    ...
    _TestClassTypeFunc.deserializeFunc = [] (void*& p, const std::string& str) {
        Deserialize<TestClass>((TestClass*&) p, str);
    };
    _TestClassTypeFunc.fillFunc = [] (void* p, const std::string& str) {
        Fill<TestClass>((TestClass*) p, str);
    };
...
void TJsonSerializer::_Deserialize( nsBS::TTestStruct* p, const Jobj& obj )
{
    ...
    if ( !POM::IsNull(obj, "spBaseStruct") ) {
        if ( p->spBaseStruct.get() == nullptr ) {
