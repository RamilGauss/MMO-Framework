...
void TJsonSerializer::Init()
{
    ...
    TypeFunc _TestClassTypeFunc;
    _TestClassTypeFunc.serializeFunc = [] (void* p, std::string& str) {
    Serialize<TestClass>((TestClass*) p, str);
    };
    _TestClassTypeFunc.deserializeFunc = [] (void*& p, const std::string& str, std::string& err) {
        return Deserialize<TestClass>((TestClass*&) p, str, err);
    };
    _TestClassTypeFunc.fillFunc = [] (void* p, const std::string& str, std::string& err) {
        return Fill<TestClass>((TestClass*) p, str, err);
    };
    mTypeNameFuncsMap.insert({"TestClass", _TestClassTypeFunc });
    mTypeNameList.push_back("TestClass");
...
//---------------------------------------------------------------------------------------
void TJsonSerializer::_Serialize( TestClass* p, Jobj& obj )
{
    ...
    PUM::Push( obj, "f", p->f );
    PUM::Push( obj, "d", p->d );
    PUM::Value myarray_a0(rapidjson::kArrayType);
    for( size_t myarray_i0 = 0 ; myarray_i0 < p->myarray.size() ; myarray_i0++ ) {
        auto& myarray_e0 = p->myarray[myarray_i0];
        PUM::PushBack( myarray_a0, myarray_e0 );
    }
    PUM::Push(obj, "myarray", myarray_a0);
}
//---------------------------------------------------------------------------------------
void TJsonSerializer::_Deserialize( TestClass* p, const Jobj& obj )
{
    ...
    if ( POM::IsArray(obj, "myarray") ) {
        auto myarray_a0 = POM::FindArray(obj, "myarray");
        for( auto& myarray_e0 : myarray_a0 ) {
            p->myarray.push_back(myarray_e0.GetInt64());
        }
    } else {
        int myarray_t0;
        POM::PopNum(obj, "myarray", myarray_t0);
        p->myarray.push_back(myarray_t0);
    }
}
//---------------------------------------------------------------------------------------
...
void TJsonSerializer::_Serialize( nsBS::TTestStruct* p, Jobj& obj )
{
    ...
    PUM::Push( obj, "floating", p->floating );
    ...
    PUM::Value doubleList_a0(rapidjson::kArrayType);
    for( auto& doubleList_e0 : p->doubleList ) {
        PUM::PushBack( doubleList_a0, doubleList_e0 );
    }
    PUM::Push(obj, "doubleList", doubleList_a0);
    ...
    PUM::Value doubleVector_a0(rapidjson::kArrayType);
    for( size_t doubleVector_i0 = 0 ; doubleVector_i0 < p->doubleVector.size() ; doubleVector_i0++ ) {
        auto& doubleVector_e0 = p->doubleVector[doubleVector_i0];
        PUM::PushBack( doubleVector_a0, doubleVector_e0 );
    }
    PUM::Push(obj, "doubleVector", doubleVector_a0);
    ...
    auto intDoubleMap_c0 = PUM::AddObject(obj, "intDoubleMap");
    for( auto& intDoubleMap_e0 : p->intDoubleMap ) {
        PUM::Push( intDoubleMap_c0, PUM::ConvertToString(intDoubleMap_e0.first).data(), intDoubleMap_e0.second );
    }
    ...
    auto intIntStrMap_c0 = PUM::AddObject(obj, "intIntStrMap");
    for( auto& intIntStrMap_e0 : p->intIntStrMap ) {
        auto intIntStrMap_c1 = PUM::AddObject(intIntStrMap_c0, PUM::ConvertToString(intIntStrMap_e0.first).data());
        for( auto& intIntStrMap_e1 : intIntStrMap_e0.second ) {
            PUM::Push( intIntStrMap_c1, PUM::ConvertToString(intIntStrMap_e1.first).data(), intIntStrMap_e1.second );
        }
    }
    ...
    auto strDoubleMap_c0 = PUM::AddObject(obj, "strDoubleMap");
    for( auto& strDoubleMap_e0 : p->strDoubleMap ) {
        PUM::Push( strDoubleMap_c0, PUM::ConvertToString(strDoubleMap_e0.first).data(), strDoubleMap_e0.second );
    }
    ...
    auto intListMap_c0 = PUM::AddObject(obj, "intListMap");
    for( auto& intListMap_e0 : p->intListMap ) {
        PUM::Value intListMap_a1(rapidjson::kArrayType);
        for( auto& intListMap_e1 : intListMap_e0.second ) {
            PUM::PushBack( intListMap_a1, intListMap_e1 );
        }
        PUM::Push(intListMap_c0, PUM::ConvertToString(intListMap_e0.first).data(), intListMap_a1);
    }
    auto intListVecMap_c0 = PUM::AddObject(obj, "intListVecMap");
    for( auto& intListVecMap_e0 : p->intListVecMap ) {
        PUM::Value intListVecMap_a1(rapidjson::kArrayType);
        for( auto& intListVecMap_e1 : intListVecMap_e0.second ) {
            PUM::Value intListVecMap_a2(rapidjson::kArrayType);
            for( size_t intListVecMap_i2 = 0 ; intListVecMap_i2 < intListVecMap_e1.size() ; intListVecMap_i2++ ) {
                auto& intListVecMap_e2 = intListVecMap_e1[intListVecMap_i2];
                PUM::PushBack( intListVecMap_a2, intListVecMap_e2 );
            }
            PUM::PushBack(intListVecMap_a1, intListVecMap_a2);
        }
        PUM::Push(intListVecMap_c0, PUM::ConvertToString(intListVecMap_e0.first).data(), intListVecMap_a1);
    }
    PUM::Value intMapList_a0(rapidjson::kArrayType);
    for( auto& intMapList_e0 : p->intMapList ) {
        PUM::Value intMapList_a1(rapidjson::kObjectType);
        auto intMapList_c1 = intMapList_a1.GetObject();
        for( auto& intMapList_e1 : intMapList_e0 ) {
            PUM::Push( intMapList_c1, PUM::ConvertToString(intMapList_e1.first).data(), intMapList_e1.second );
        }
    }
    PUM::Push(obj, "intMapList", intMapList_a0);
    auto intVecMap_c0 = PUM::AddObject(obj, "intVecMap");
    for( auto& intVecMap_e0 : p->intVecMap ) {
        PUM::Value intVecMap_a1(rapidjson::kArrayType);
        for( size_t intVecMap_i1 = 0 ; intVecMap_i1 < intVecMap_e0.second.size() ; intVecMap_i1++ ) {
            auto& intVecMap_e1 = intVecMap_e0.second[intVecMap_i1];
            PUM::PushBack( intVecMap_a1, intVecMap_e1 );
        }
        PUM::Push(intVecMap_c0, PUM::ConvertToString(intVecMap_e0.first).data(), intVecMap_a1);
    }
    PUM::Value intMapVec_a0(rapidjson::kArrayType);
    for( size_t intMapVec_i0 = 0 ; intMapVec_i0 < p->intMapVec.size() ; intMapVec_i0++ ) {
        auto& intMapVec_e0 = p->intMapVec[intMapVec_i0];
        PUM::Value intMapVec_a1(rapidjson::kObjectType);
        auto intMapVec_c1 = intMapVec_a1.GetObject();
        for( auto& intMapVec_e1 : intMapVec_e0 ) {
            PUM::Push( intMapVec_c1, PUM::ConvertToString(intMapVec_e1.first).data(), intMapVec_e1.second );
        }
    }
    PUM::Push(obj, "intMapVec", intMapVec_a0);
...
void TJsonSerializer::_Deserialize( nsBS::TTestStruct* p, const Jobj& obj )
{
    ...
    POM::PopNum( obj, "floating", p->floating );
    ...
    if ( POM::IsArray(obj, "doubleList") ) {
        auto doubleList_a0 = POM::FindArray(obj, "doubleList");
        for( auto& doubleList_e0 : doubleList_a0 ) {
            p->doubleList.push_back(doubleList_e0.GetDouble());
        }
    } else {
        double doubleList_t0;
        POM::PopNum(obj, "doubleList", doubleList_t0);
        p->doubleList.push_back(doubleList_t0);
    }
    ...
    if ( POM::IsArray(obj, "doubleVector") ) {
        auto doubleVector_a0 = POM::FindArray(obj, "doubleVector");
        for( auto& doubleVector_e0 : doubleVector_a0 ) {
            p->doubleVector.push_back(doubleVector_e0.GetDouble());
        }
    } else {
        double doubleVector_t0;
        POM::PopNum(obj, "doubleVector", doubleVector_t0);
        p->doubleVector.push_back(doubleVector_t0);
    }
    ...
    auto intDoubleMap_a0 = POM::FindObject(obj, "intDoubleMap");
    for( auto& intDoubleMap_e0 : intDoubleMap_a0 ) {
        p->intDoubleMap.insert({ std::stod(intDoubleMap_e0.name.GetString()), intDoubleMap_e0.value.GetDouble() });
    }
    ...
    auto intIntStrMap_a0 = POM::FindObject(obj, "intIntStrMap");
    for( auto& intIntStrMap_e0 : intIntStrMap_a0 ) {
        std::map<int,std::string> intIntStrMap_c1;
        auto intIntStrMap_a1 = intIntStrMap_e0.value.GetObject();
        for( auto& intIntStrMap_e1 : intIntStrMap_a1 ) {
            intIntStrMap_c1.insert({ std::stod(intIntStrMap_e1.name.GetString()), intIntStrMap_e1.value.GetString() });
        }
        p->intIntStrMap.insert({ intIntStrMap_e0.name.GetInt64(), intIntStrMap_c1 });
    }
    ...
    auto strDoubleMap_a0 = POM::FindObject(obj, "strDoubleMap");
    for( auto& strDoubleMap_e0 : strDoubleMap_a0 ) {
        p->strDoubleMap.insert({ strDoubleMap_e0.name.GetString(), strDoubleMap_e0.value.GetDouble() });
    }
    ...
    auto intListMap_a0 = POM::FindObject(obj, "intListMap");
    for( auto& intListMap_e0 : intListMap_a0 ) {
        if ( intListMap_e0.value.IsArray() ) {
            std::list<int> intListMap_c1;
            auto intListMap_a1 = intListMap_e0.value.GetArray();
            for( auto& intListMap_e1 : intListMap_a1 ) {
                intListMap_c1.push_back(intListMap_e1.GetInt64());
            }
            p->intListMap.insert({ intListMap_e0.name.GetString(), intListMap_c1 });
        } else {
            auto intListMap_t1 = intListMap_e0.value.GetInt64();
            std::list<int> intListMap_c1;
            intListMap_c1.push_back(intListMap_t1);
            p->intListMap.insert({ intListMap_e0.name.GetString(), intListMap_c1 });
        }
    }
    auto intListVecMap_a0 = POM::FindObject(obj, "intListVecMap");
    for( auto& intListVecMap_e0 : intListVecMap_a0 ) {
        std::list<std::vector<int>> intListVecMap_c1;
        auto intListVecMap_a1 = intListVecMap_e0.value.GetArray();
        for( auto& intListVecMap_e1 : intListVecMap_a1 ) {
            if ( intListVecMap_e1.IsArray() ) {
                std::vector<int> intListVecMap_c2;
                auto intListVecMap_a2 = intListVecMap_e1.GetArray();
                for( auto& intListVecMap_e2 : intListVecMap_a2 ) {
                    intListVecMap_c2.push_back(intListVecMap_e2.GetInt64());
                }
                intListVecMap_c1.push_back(intListVecMap_c2);
            } else {
                auto intListVecMap_t2 = intListVecMap_e1.GetInt64();
                std::vector<int> intListVecMap_c2;
                intListVecMap_c2.push_back(intListVecMap_t2);
                intListVecMap_c1.push_back(intListVecMap_c2);
            }
        }
        p->intListVecMap.insert({ intListVecMap_e0.name.GetString(), intListVecMap_c1 });
    }
    auto intMapList_a0 = POM::FindArray(obj, "intMapList");
    for( auto& intMapList_e0 : intMapList_a0 ) {
        std::map<std::string,int> intMapList_c1;
        auto intMapList_a1 = intMapList_e0.GetObject();
        for( auto& intMapList_e1 : intMapList_a1 ) {
            intMapList_c1.insert({ intMapList_e1.name.GetString(), intMapList_e1.value.GetInt64() });
        }
        p->intMapList.push_back(intMapList_c1);
    }
    auto intVecMap_a0 = POM::FindObject(obj, "intVecMap");
    for( auto& intVecMap_e0 : intVecMap_a0 ) {
        if ( intVecMap_e0.value.IsArray() ) {
            std::vector<int> intVecMap_c1;
            auto intVecMap_a1 = intVecMap_e0.value.GetArray();
            for( auto& intVecMap_e1 : intVecMap_a1 ) {
                intVecMap_c1.push_back(intVecMap_e1.GetInt64());
            }
            p->intVecMap.insert({ intVecMap_e0.name.GetInt64(), intVecMap_c1 });
        } else {
            auto intVecMap_t1 = intVecMap_e0.value.GetInt64();
            std::vector<int> intVecMap_c1;
            intVecMap_c1.push_back(intVecMap_t1);
            p->intVecMap.insert({ std::stod(intVecMap_e0.name.GetString()), intVecMap_c1 });
        }
    }
    auto intMapVec_a0 = POM::FindArray(obj, "intMapVec");
    for( auto& intMapVec_e0 : intMapVec_a0 ) {
        std::map<int,int> intMapVec_c1;
        auto intMapVec_a1 = intMapVec_e0.GetObject();
        for( auto& intMapVec_e1 : intMapVec_a1 ) {
            intMapVec_c1.insert({ std::stod(intMapVec_e1.name.GetString()), intMapVec_e1.value.GetInt64() });
        }
        p->intMapVec.push_back(intMapVec_c1);
    }
