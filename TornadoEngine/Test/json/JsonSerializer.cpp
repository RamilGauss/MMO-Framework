...
test
*/
// File has been generated by ReflectionCodeGenerator version 1.14 build 42, at 2020_09_13 14:04:16.889
...
void TJsonSerializer::_Serialize( TestClass* p, Jobj& obj )
{
    ...
    Jarr myarray_c0;
    for ( int myarray_i0 = 0 ; myarray_i0 < p->myarray.size() ; myarray_i0++ )
    {
        auto& myarray_e0 = p->myarray[myarray_i0];
        myarray_c0.push_back( myarray_e0 );
    }
    PUM::Push( obj, "myarray", myarray_c0 );
}
//---------------------------------------------------------------------------------------
void TJsonSerializer::_Deserialize( TestClass* p, const json11::Json& json )
{
    POM::PopNum( json, "i8", p->i8 );
    POM::PopNum( json, "ui8", p->ui8 );
    POM::PopNum( json, "i16", p->i16 );
    POM::PopNum( json, "ui16", p->ui16 );
    POM::PopNum( json, "i32", p->i32 );
    POM::PopNum( json, "ui32", p->ui32 );
    POM::PopNum( json, "c", p->c );
    POM::PopNum( json, "uc", p->uc );
    POM::PopNum( json, "s", p->s );
    POM::PopNum( json, "us", p->us );
    POM::PopNum( json, "i", p->i );
    POM::PopNum( json, "ui", p->ui );
    POM::PopNum( json, "f", p->f );
    POM::PopNum( json, "d", p->d );
    
    auto& myarray_src0 = json["myarray"].array_items();
    for ( auto& myarray_e0 : myarray_src0 )
    {
        p->myarray.push_back( (int)(myarray_e0.number_value()) );
    }
}
//---------------------------------------------------------------------------------------
