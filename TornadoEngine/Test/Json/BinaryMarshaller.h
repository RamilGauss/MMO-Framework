...
*/
// File has been generated by ReflectionCodeGenerator version 1.6 build 34, at 2019_02_06 15:01:46.797
...
namespace nsBinary
{
  ...
  public:
    ...
    template <typename Type>
    static void Deallocate( const Type* p );
  private:
  ...
  //-----------------------------------------------------------------------------
  template <typename Type>
  void TBinaryMarshaller::Deallocate( const Type* p )
  {
