...
*/
// File has been generated by ReflectionCodeGenerator version 1.6 build 34, at 2019_02_07 16:54:04.006
...
namespace nsBinary
{
  ...
  {
    return (Type*) TMemoryObjectPoolAllocator::AllocateFunc<Type>();
  }
  //-----------------------------------------------------------------------------
  template <typename Type>
