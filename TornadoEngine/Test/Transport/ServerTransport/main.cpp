...
int main( int argc, char** argv )
{
  ...
  g_pServerTransport->GetCallbackRecv()->Register( &THandler::Recv, &g_Handler );
  g_pServerTransport->GetCallbackDisconnect()->Register( &THandler::Disconnect, &g_Handler );
  g_pServerTransport->GetCallbackConnectFrom()->Register( &THandler::ConnectFrom, &g_Handler );
