...
{
    int rtti;
    auto result = nsTypeInformation::TTypeInformationSerializer::ConvertNameToRtti("InitSystem", rtti);
    ASSERT_TRUE(result);

    InitSystem initSystem;
    initSystem.SetEntMng(&g_EntMng);
    void* pInitSystem = (void*)&initSystem;
    auto pSystem = nsTest::TEcsSystemExtension::DynamicCast(pInitSystem, rtti);
...
{
    int rtti;
    auto result = nsTypeInformation::TTypeInformationSerializer::ConvertNameToRtti("ExecuteSystem", rtti);
    ASSERT_TRUE(result);
...
{
    int rtti;
    auto result = nsTypeInformation::TTypeInformationSerializer::ConvertNameToRtti("TearDownSystem", rtti);
    ASSERT_TRUE(result);
...
{
    int rtti;
    auto result = nsTypeInformation::TTypeInformationSerializer::ConvertNameToRtti("Feature", rtti);
    ASSERT_TRUE(result);
...
{
    int rtti;
    auto result = nsTypeInformation::TTypeInformationSerializer::ConvertNameToRtti("OnAddCollect", rtti);
    ASSERT_TRUE(result);
...
{
    int rtti;
    auto result = nsTypeInformation::TTypeInformationSerializer::ConvertNameToRtti("OnUpdateCollect", rtti);
    ASSERT_TRUE(result);
...
{
    int rtti;
    auto result = nsTypeInformation::TTypeInformationSerializer::ConvertNameToRtti("OnAddInstant", rtti);
    ASSERT_TRUE(result);
...
{
    int rtti;
    auto result = nsTypeInformation::TTypeInformationSerializer::ConvertNameToRtti("OnUpdateInstant", rtti);
    ASSERT_TRUE(result);
...
{
    int rtti;
    auto result = nsTypeInformation::TTypeInformationSerializer::ConvertNameToRtti("OnRemoveInstant", rtti);
    ASSERT_TRUE(result);
