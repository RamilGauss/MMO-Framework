...
float    g_fReflectivity = 0.09f;                  // Reflectivity value
//-----------------------------------------------------------------------------
// Sampler: samCubeMap
...
float4 HDRPixEnvMap( float2 vTexCoord: TEXCOORD0,
				             ...
				             float3 Tex      : TEXCOORD1 ): COLOR	 
{
  ...
  {
    //colorMirror.rgb *= COEF_COLOR_FOR_REFLECT;//float4(1.0f,1.0f,1.0f,1.0f);
